...
const inputStyle = tva({
  base: 'border-background-300 flex-row overflow-hidden content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-gray-800 data-[focus=true]:border-2 data-[focus=true]:hover:border-gray-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300 items-center',
...
const inputIconStyle = tva({
  base: 'justify-center items-center text-typography-400 fill-none text-gray-600',
  parentVariants: {
    size: {
      '2xs': 'h-3 w-3',
      'xs': 'h-3.5 w-3.5',
